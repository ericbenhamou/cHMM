...
def load_data():
    ...
    data_CHF_obj = Data_loader(CHFDataFile, folder, True, delimiter=',', date_format='%Y%m%d %H%M%S')
    GoldDataFile = "GC ##-##.Last.csv"
    data_Gold_obj = Data_loader(GoldDataFile, folder, True, delimiter=',', date_format='%Y%m%d %H%M%S')
